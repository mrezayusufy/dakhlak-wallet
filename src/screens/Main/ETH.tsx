import { View, Text, SafeAreaView, StatusBar, KeyboardAvoidingView, Image, Dimensions, ImageBackground, TouchableOpacity, TextInput, ScrollView } from 'react-native'
                ...
                <View style={[style.main, { backgroundColor: Colors.bg, marginTop: 30 }]}>
                    ...
                    <ScrollView showsVerticalScrollIndicator={false} style={{ marginTop: 10 }}>
                        <View style={{ alignItems: 'center' }}>
                            <Image source={{uri: icons.eth}} width={24} height={24} />
                        </View>
                        <Text style={[style.title, { color: Colors.active, textAlign: 'center' }]}>$43,87.85</Text>
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                            <Icon name='chevron-up' size={15} color={Colors.primary} style={{ marginTop: -5 }} />
                            <Text style={[style.m14, { color: Colors.disable1, marginLeft: 2 }]}>12.67%</Text>
                        </View>

                        <Image source={require('@/assets/image/s18.png')} resizeMode='stretch' style={{ marginTop: 10, height: height / 4, width: width - 40 }} />
                        ...
                        <View style={{ marginTop: 30, marginBottom: 50 }}>
                            ...
                            <View style={{ marginTop: -90, padding: 15, backgroundColor: Colors.secondary, flexDirection: 'row', alignItems: 'center', borderRadius: 15 }}>
                                <View style={{ flex: 1 }}>
                                    <Text style={[style.s15, { color: Colors.active }]}>Your Etherium Address:</Text>
                                    <Text style={[style.r12, { color: Colors.txt }]}>985ff9f177usaeei0e99e87qr0599...</Text>
                                </View>
